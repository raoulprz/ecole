...
/**
 * Main Elementor Custom Buttons Class
 *
 * The init class that runs the Elementor Custom Buttons plugin.
 ...
 */
final class Elementor_Blog_Template {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-custom-buttons' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_BLOG_TEMPLATE ) );
...
// Instantiate Elementor_Blog_Template.
new Elementor_Blog_Template();
